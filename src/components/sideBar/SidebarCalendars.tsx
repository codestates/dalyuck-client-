...
export default function SidebarCalendars({myOrOther, setIsOpen, isOpen}:{myOrOther:string;setIsOpen:React.Dispatch<React.SetStateAction<boolean>>,isOpen:boolean}) {
